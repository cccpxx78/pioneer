...
void WorldView::InitObject()
{
	...
	*/
	...
	Add(m_hudScannerGauge, 5.0f, Gui::Screen::GetHeight() - 144.0f);
	Add(m_hudHullTemp, 5.0f, Gui::Screen::GetHeight() - 184.0f);
	Add(m_hudWeaponTemp, 5.0f, Gui::Screen::GetHeight() - 224.0f);
